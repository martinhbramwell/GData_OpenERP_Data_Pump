...
class IrModuleModule(OErpModel):
    ...
    def __init__(self):
        ...
        self.methods = {
            'chkTask': self.chkTask, 'install_module': self.install_module
        }
    ...
    def chkTask(self, parms):
        ...
        print 'Check for "titles_row" found : "' + parms['titles_row'] + '"!'
        print 'Check for "data_range" found : "' + parms['data_range'] + '"!'
    ...
    def install_module(self, parms):
        ...
        while (idx < module_parms['dictRange']['maxRow']):
            ...
            if not module['state'] == 'installed':
                ...
                print 'Doing nothing with module "{}" in state "{}"'.format(
                    nameModule, stateModule)
